...
# from mahdinlib.utils.sounds import play_error_sound
# from mahdinlib.utils.sounds import play_finish_sound
...
#         print(mahdinlib.constants.NO_SCENE_MESSAGE)
#         return []
#     if config["write_all"]:
